...
<body onload="character()">
  <div class="jumbotron">
    <div class="container">
      <h1 class="header-main-title">Teste para vaga de Desenvolvedor Front-end</h1>
      <form id="connectionForm">
        ...
        <input type="submit" value="Procurar" class="btn btn-danger mb-2 float-right search-character-button">
